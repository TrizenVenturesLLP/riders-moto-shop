    ...
    <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        <div className="flex items-center justify-center mb-6">
          ...
          <span className="text-red-600 font-semibold">Premium Bike Parts</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-red-600 hover:bg-red-700 glow-red">
            Shop Now
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
          <Button variant="outline" size="lg" className="border-white hover:bg-white hover:text-black">
            Browse Categories
          </Button>
        </div>
