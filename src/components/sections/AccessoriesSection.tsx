...
const AccessoriesSection = () => {
  return (
    <section id="shop-accessories" className="mt-12 pt-16 pb-8 bg-background">
      <div className="container mx-auto px-4 max-w-7xl">
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-[5/3] flex items-center justify-center">
                  ...
                  <div className="hidden w-10 h-10 bg-primary/10 dark:bg-primary/20 rounded flex items-center justify-center">
                ...
                <div className="text-center mt-1">
                  <h3 className="text-[9px] font-semibold text-foreground uppercase tracking-wide group-hover:text-primary transition-colors leading-tight">
                    {accessory.name}
                  </h3>
                </div>
              </div>
        ...
        <div className="text-center mt-12">
          <Button 
            size="default" 
            variant="outline" 
            className="bg-background border border-border text-foreground hover:bg-accent hover:text-accent-foreground px-7 py-3.5  font-medium"
            onClick={() => {
